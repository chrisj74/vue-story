<template>
    <div ref="page">
        <q-page class="story-page row justify-center">
            <div class="flex column justify-center tools">
                ...
                <q-btn icon="cloud_download" round @click="download()" />
            </div>
            ...
            <div class="flex column justify-center extra-tools" v-if="canvas">
...
export default {
    ...
    mounted() {
        ...
        window.addEventListener('resize', function(event) {
            ...
            _this.canvas.loadFromJSON(_this.story.json, _this.canvas.renderAll.bind(_this.canvas));
    ...
    methods: {
        ...
        setPageSize() {
            this.page.height = this.$refs.page.clientHeight - 20;
            this.page.width = this.$refs.page.clientWidth - 20;
        },
        setDefaultZoom() {
            this.setPageSize();
    ...
    watch: {
        ...
        insertImage: {
            handler: function(newImage, oldImage) {
                console.log('watcher insertImage=', newImage);
                if (newImage) {
        ...
        activePage: {
            handler: function(newPage, oldPage) {
                console.log('story changed newPage=', newPage);
